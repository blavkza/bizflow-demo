...
export function HealthSafetyCard({
  ...
  const form = useForm<HealthSafetySchemaType>({
    ...
    defaultValues: {
      medicalCondition: getSafeStringValue(freelancer.medicalCondition),
      allergies: getSafeStringValue(freelancer.allergies),
      restrictions: getSafeStringValue(freelancer.restrictions),
      firstAidNeeds: getSafeStringValue(freelancer.firstAidNeeds),
      riskLevel: getSafeStringValue(freelancer.riskLevel),
      additionalInfo: getSafeStringValue(freelancer.additionalInfo),
      emergencyContacts: parseEmergencyContacts(freelancer.emergencyContacts),
    },
  });
  ...
  const onSubmit = async (values: HealthSafetySchemaType) => {
    ...
    try {
      ...
      await axios.put(
        `/api/freelancers/${freelancer.id}/health-safety`,
        formattedData
      );
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {getDisplayValue(freelancer.medicalCondition)}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {getDisplayValue(freelancer.allergies)}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {getDisplayValue(freelancer.restrictions)}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {getDisplayValue(freelancer.firstAidNeeds)}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getRiskLevelColor(freelancer.riskLevel!)}`}
                    >
                      {getRiskLevelDisplay(freelancer.riskLevel!)}
                    </span>
                  </div>
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {parseEmergencyContacts(freelancer.emergencyContacts) ||
                      "No emergency contacts specified"}
                  </p>
                </div>

                {freelancer.additionalInfo && (
                  <div className="md:col-span-2">
                    <p className="font-medium">Additional Information</p>
                    <p className="text-sm text-muted-foreground mt-1">
                      {getDisplayValue(freelancer.additionalInfo)}
                    </p>
                  </div>
                )}
              </div>
