...
export function PersonalInfoCard({
  ...
  const form = useForm<PersonalInfoSchemaType>({
    ...
    defaultValues: {
      ...
      branchCode: freelancer.branchCode || "",
  ...
  const onSubmit = async (values: PersonalInfoSchemaType) => {
    ...
    try {
      await axios.put(
        `/api/freelancers/${freelancer.id}/personal-info`,
        values
      );
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {freelancer.idNumber || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Tax Number</p>
                    <p className="text-sm text-muted-foreground">
                      {freelancer.taxNumber || "Not specified"}
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {freelancer.maritalStatus || "Not specified"}
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {freelancer.bankName || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Account Number</p>
                    <p className="text-sm text-muted-foreground">
                      {freelancer.accountNumber || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Branch Code</p>
                    <p className="text-sm text-muted-foreground">
                      {freelancer.branchCode || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Account Type</p>
                    <p className="text-sm text-muted-foreground">
                      {freelancer.accountType || "Not specified"}
                    </p>
                  </div>
                </div>
              </CardContent>
