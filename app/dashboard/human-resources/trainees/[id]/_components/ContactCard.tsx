...
export function ContactCard({
  ...
  const form = useForm<ContactInfoSchemaType>({
    ...
    defaultValues: {
      ...
      emergencyName: trainee.emergencyName || "",
      emergencyPhone: trainee.emergencyPhone || "",
      emergencyRelation: trainee.emergencyRelation || "",
      emergencyAddress: trainee.emergencyAddress || "",
    },
  });
  ...
  const onSubmit = async (values: ContactInfoSchemaType) => {
    setIsLoading(true);
    try {
      await axios.put(`/api/trainees/${trainee.id}/contact-info`, values);
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {trainee.department?.name || "Not specified"}
                    </p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
              ...
              <div className="pt-4 border-t">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {trainee.address || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">City</p>
                    <p className="text-sm text-muted-foreground">
                      {trainee.city || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Province/State</p>
                    <p className="text-sm text-muted-foreground">
                      {trainee.province || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Postal Code</p>
                    <p className="text-sm text-muted-foreground">
                      {trainee.postalCode || "Not specified"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 border-t">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {trainee.emergencyName || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Phone</p>
                    <p className="text-sm text-muted-foreground">
                      {trainee.emergencyPhone || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Relationship</p>
                    <p className="text-sm text-muted-foreground">
                      {trainee.emergencyRelation || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Address</p>
                    <p className="text-sm text-muted-foreground">
                      {trainee.emergencyAddress || "Not specified"}
                    </p>
                  </div>
                </div>
              </div>
