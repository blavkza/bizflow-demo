...
export function DocumentsTab({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append("entityType", "trainee");
      formData.append("entityId", trainee.id);
          ...
          >
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Upload a document for {trainee.firstName} {trainee.lastName}
                </DialogDescription>
              </DialogHeader>
