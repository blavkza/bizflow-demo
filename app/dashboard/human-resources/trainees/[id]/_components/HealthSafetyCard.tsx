...
export function HealthSafetyCard({
  ...
  const form = useForm<HealthSafetySchemaType>({
    ...
    defaultValues: {
      medicalCondition: getSafeStringValue(trainee.medicalCondition),
      allergies: getSafeStringValue(trainee.allergies),
      restrictions: getSafeStringValue(trainee.restrictions),
      firstAidNeeds: getSafeStringValue(trainee.firstAidNeeds),
      riskLevel: getSafeStringValue(trainee.riskLevel),
      additionalInfo: getSafeStringValue(trainee.additionalInfo),
      emergencyContacts: parseEmergencyContacts(trainee.emergencyContacts),
    },
  });
  ...
  const onSubmit = async (values: HealthSafetySchemaType) => {
    ...
    try {
      ...
      await axios.put(
        `/api/trainees/${trainee.id}/health-safety`,
        formattedData,
      );
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {getDisplayValue(trainee.medicalCondition)}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {getDisplayValue(trainee.allergies)}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {getDisplayValue(trainee.restrictions)}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {getDisplayValue(trainee.firstAidNeeds)}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getRiskLevelColor(trainee.riskLevel!)}`}
                    >
                      {getRiskLevelDisplay(trainee.riskLevel!)}
                    </span>
                  </div>
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {parseEmergencyContacts(trainee.emergencyContacts) ||
                      "No emergency contacts specified"}
                  </p>
                </div>

                {trainee.additionalInfo && (
                  <div className="md:col-span-2">
                    <p className="font-medium">Additional Information</p>
                    <p className="text-sm text-muted-foreground mt-1">
                      {getDisplayValue(trainee.additionalInfo)}
                    </p>
                  </div>
                )}
              </div>
