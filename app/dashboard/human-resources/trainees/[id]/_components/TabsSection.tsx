...
export default function TabsSection({
  ...
  const handleDownloadPayslip = async (paymentId: string) => {
    ...
    try {
      ...
      pdf.save(
        `payslip-${trainee.lastName}-${trainee.firstName}-${format(new Date(), "yyyyMMdd")}.pdf`,
      );
    } catch (error) {
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="">
            <div className="lg:col-span-2 space-y-6">
              <EmploymentDetailsCard trainee={trainee} />
              <ContactCard
                trainee={trainee}
        ...
        <TabsContent value="payments" className="space-y-4">
          <Card className="border-none shadow-none">
            ...
            <CardContent className="px-0">
              ...
              ) : trainee.payments && trainee.payments.length > 0 ? (
                <div>
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableRow key={payment.id}>
                          ...
                          <TableCell>
                            <Button
                              ...
                              disabled={generatingPayslipId === payment.id}
                            >
        ...
        <TabsContent value="documents" className="space-y-4">
          <DocumentsTab
            ...
            fetchTrainee={fetchTrainee}
            hasFullAccess={hasFullAccess}
            canEditTrainee={canEditTrainees}
          />
        </TabsContent>
      </Tabs>
    </div>
