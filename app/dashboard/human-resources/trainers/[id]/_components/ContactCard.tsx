...
export function ContactCard({
  ...
  const form = useForm<ContactInfoSchemaType>({
    ...
    defaultValues: {
      ...
      emergencyName: trainer.emergencyName || "",
      emergencyPhone: trainer.emergencyPhone || "",
      emergencyRelation: trainer.emergencyRelation || "",
      emergencyAddress: trainer.emergencyAddress || "",
    },
  });
  ...
  const onSubmit = async (values: ContactInfoSchemaType) => {
    setIsLoading(true);
    try {
      await axios.put(`/api/trainers/${trainer.id}/contact-info`, values);
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {trainer.department?.name || "Not specified"}
                    </p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
              ...
              <div className="pt-4 border-t">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {trainer.city || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Province/State</p>
                    <p className="text-sm text-muted-foreground">
                      {trainer.province || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Postal Code</p>
                    <p className="text-sm text-muted-foreground">
                      {trainer.postalCode || "Not specified"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 border-t">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {trainer.emergencyName || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Phone</p>
                    <p className="text-sm text-muted-foreground">
                      {trainer.emergencyPhone || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Relationship</p>
                    <p className="text-sm text-muted-foreground">
                      {trainer.emergencyRelation || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <p className="font-medium">Address</p>
                    <p className="text-sm text-muted-foreground">
                      {trainer.emergencyAddress || "Not specified"}
                    </p>
                  </div>
                </div>
              </div>
