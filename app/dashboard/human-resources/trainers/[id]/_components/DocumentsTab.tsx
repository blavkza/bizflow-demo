...
export function DocumentsTab({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append("entityType", "trainer");
      formData.append("entityId", trainer.id);
          ...
          >
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Upload a document for {trainer.firstName} {trainer.lastName}
                </DialogDescription>
              </DialogHeader>
