...
export default function TabsSection({
  ...
  const handleDownloadPayslip = async (paymentId: string) => {
    ...
    try {
      ...
      pdf.save(
        `payslip-${trainer.lastName}-${trainer.firstName}-${format(new Date(), "yyyyMMdd")}.pdf`,
      );
    } catch (error) {
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="">
            <div className="lg:col-span-2 space-y-6">
              <EmploymentDetailsCard trainer={trainer} />
              <ContactCard
                trainer={trainer}
        ...
        <TabsContent value="payments" className="space-y-4">
          <Card className="border-none shadow-none">
            ...
            <CardContent className="px-0">
              ...
              ) : trainer.payments && trainer.payments.length > 0 ? (
                <div>
                  <Table>
                    <TableHeader>
                      <TableRow>
        ...
        <TabsContent value="documents" className="space-y-4">
          <DocumentsTab
            ...
            fetchTrainer={fetchTrainer}
            hasFullAccess={hasFullAccess}
            canEditTrainer={canEditTrainers}
          />
        </TabsContent>
      </Tabs>
    </div>
