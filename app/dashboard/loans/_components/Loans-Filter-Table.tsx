                ...
                <Table>
                  ...
                  <TableBody>
                    {paginatedLoans.map((loan) => {
                      ...
                      const balance = Math.max(0, finalTotalPayable - totalPaid);
                      const progress = Math.min(100, Math.max(0, (totalPaid / (finalTotalPayable || 1)) * 100));
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell className="font-semibold">
                            R{loan.amount.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                          </TableCell>
                          <TableCell>
                          ...
                          <TableCell className="text-right" onClick={(e) => e.stopPropagation()}>
                             <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                  ...
                                  <DropdownMenuItem onClick={() => onEdit(loan)} className="flex items-center cursor-pointer">
